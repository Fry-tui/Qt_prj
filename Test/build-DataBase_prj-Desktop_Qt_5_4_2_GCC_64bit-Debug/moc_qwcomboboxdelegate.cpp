...
#include "../DataBase_prj/qwcomboboxdelegate.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_QWComboBoxDelegate_t, stringdata) + ofs \
...
const QMetaObject QWComboBoxDelegate::staticMetaObject = {
    { &QStyledItemDelegate::staticMetaObject, qt_meta_stringdata_QWComboBoxDelegate.data,
      qt_meta_data_QWComboBoxDelegate,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *QWComboBoxDelegate::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QWComboBoxDelegate.stringdata))
